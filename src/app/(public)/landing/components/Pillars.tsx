...
const DEFAULT_ITEMS: Pillar[] = [
    ...
    {
        label: "AI & Digital",
        title: "The Experts in Custom AI",
        content: <p>Harness AI to build intelligent systems and applications.</p>,
        outcomes: ["AI-powered applications", "Multi-agent orchestration", "RAG & semantic search"],
        priceText: "",
        imageSrc: "/images/landing/custom.png",
        primaryLabel: "View Service",
        primaryHref: "/services/AI-Solutions",
        primaryUsesContactModal: false,
